...
to assign the Team tier. Matching test subscriptions and their generated customers are cancelled
and removed at the end, including when webhook processing failed before Postgres stored an id.
